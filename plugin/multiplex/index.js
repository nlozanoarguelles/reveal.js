...
app.use(function(req, res, next) {
    ...
    if (req.query.uuid) {
        res.cookie('uuid', decodeURIComponent(req.query.uuid), { maxAge: 1000 * 60 * 60 * 24 * 331, httpOnly: false });
...
app.use('/', staticDir(opts.baseDir + 'public'));
['css', 'js', 'plugin', 'lib', 'res', 'public'].forEach(function(dir) {
